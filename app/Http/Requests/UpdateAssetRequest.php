...
{
    /**
     * The asset ID that should be excluded from the unique check.
     */
    protected $assetId;
    ...
    public function rules(): array
    {
        return [
            'asset_code' => [
                ...
                'string',
                'max:50',
                Rule::unique('assets')->ignore($this->assetId)->whereNull('deleted_at'),
            ],
            ...
            'status' => 'sometimes|required|in:operational,under-maintenance,out-of-service,retired,available,in_use,disposed,lost',
