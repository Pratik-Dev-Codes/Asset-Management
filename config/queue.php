...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Configure memory limits and monitoring for queue workers.
    |
    */

    'memory' => [
        'limit' => env('QUEUE_WORKER_MEMORY_LIMIT', 128), // in MB
        'threshold' => env('QUEUE_WORKER_MEMORY_THRESHOLD', 80), // percentage
        'monitor_interval' => env('QUEUE_WORKER_MONITOR_INTERVAL', 60), // seconds
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configure the default queue worker settings.
    |
    */
    'worker' => [
